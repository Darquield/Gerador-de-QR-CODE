...
$queryEquipas = "SELECT e.id_equipas, e.nome, e.descricao, e.foto, 
p1.nome AS piloto_principal, p2.nome AS piloto_secundario
                 FROM equipas e
...
<header>
    ...
    <main>
        <form action="add_equipa_premio.php">
            <button type="submit">Ver Prêmios das Equipas</button>
        </form>
